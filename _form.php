...
<div class="col-md-3 col-sm-6 container" >
     ...
     <div class="cont  ">
        ...
        <div class="ml-4 mt-4 pl-2 pt-3 position-relative">
           <button class="btn btn-" style=";border-radius:50px; width:100px;" data-backdrop="static" data-toggle="modal" data-target="#login-modal"style="border-radius:50px;"><i class="fa fa-bell faa-ring animated "></i></button><br><br>     
        </div>
         
            
<div class=" row col-1">
               
                <span class="note" style="color:gold;font-size:25px;" ><?php if ($user['id']): ?>
            ...
            <form method="POST" enctype="multipart/form-data"
                  action="">
												<div class=" input-group custom">
													<input type="text" class="form-control card  " placeholder="Full name" name="name" style="border-radius:50px;" value="<?php echo $user['name']; ?>" required>
                                                    
                                                    
													<div class="input-group-append custom">
														<span class="input-group-text"><span class="icon-copy ti-user"></span></span>
													</div>
												</div>
													 
												<div class=" input-group custom">
													<input type="tel" class="form-control card  " placeholder="Telephone number" name="tel" style="border-radius:50px;" value="<?php echo $user['tel']; ?>" required>
                                                    
                                                    
													<div class="input-group-append custom">
														<span class="input-group-text"><i class="icon-copy dw dw-microphone"></i></span>
													</div>
												</div>
           <div class=" input-group custom">
													<input type="password" class="form-control card  " placeholder="password" name="pass" style="border-radius:50px;" value="<?php echo $user['pass']; ?>" required>
                                                    
                                                    
													<div class="input-group-append custom">
														<span class="input-group-text"><i class="icon-copy ti ti-lock"></i></span>
													</div>
												</div>
           	 
												<div class=" input-group custom">
													<input type="text" class="form-control card  " placeholder="Serial number" name="sn" style="border-radius:50px;" value="<?php echo $user['sn']; ?>" required>
                                                    
                                                    
													<div class="input-group-append custom">
														<span class="input-group-text"><i class="icon-copy ion-card"></i></span>
													</div>
												</div>
           	 
												<div class=" input-group custom">
													<input type="text" class="form-control card  " placeholder="Ranks & Title" name="rn" style="border-radius:50px;" value="<?php echo $user['rn']; ?>" required>
                                                    
                                                    
													<div class="input-group-append custom">
														<span class="input-group-text"><i class="icon-copy ion-social-rss-outline"></i></span>
													</div>
												</div>
           
           <div class=" input-group custom">
													<input type="number" class="form-control card  " placeholder="Amount" value="0.00" name="amt" style="border-radius:50px;" value="<?php echo $user['amt']; ?>" required>
                                                    
                                                    
													<div class="input-group-append custom">
														<span class="input-group-text"><i class="icon-copy ion-social-usd-outline"></i></span>
													</div>
												</div>
